export const ABOUT = [
    "Hello there! Thank you for visiting my personal website. I'm Farel Rasyah, a student majoring in Information Systems at the University of Malang. I have a strong interest in frontend development. With a solid foundation in JavaScript and TypeScript, as well as a comprehensive understanding of various frontend libraries and frameworks, I have navigated the ever-evolving landscape of web development with enthusiasm and dedication.",
