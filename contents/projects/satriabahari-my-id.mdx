...
```bash
npx create-next-app -e https://github.com/farelrasyah/farelrasyah.my.id your-app-name
```

```bash
npx degit farelrasyah/farelrasyah.my.id your-app-name
```
...
🧠 Made with curiosity, love, and caffeine ☕ by [Farel Rasyah](https://farelrasyah.my.id)
